...
Subject to the limitations in Section 3, the Licensor grants You a non-exclusive, royalty-free, worldwide, non-sublicensable, non-transferable license to:

a. use, run, and self-host the Software, including for commercial purposes;
b. copy, modify, and create derivative works of the Software;
c. redistribute the Software or derivative works, subject to Section 3(b) below.

This License also includes a limited patent license: the Licensor grants You a license, under any patent claims the Licensor can license, to make, use, sell, offer for sale, import, and have imported the Software, subject to the limitations in this License. This patent license does not extend to claims caused by modifications or additions You make to the Software.

## 3. Limitations

a. **No Resale or White-Labeling of the Software Itself.** You may not sell, rent, lease, sublicense, host as a paid or unpaid service for third parties, or otherwise make the Software — or a derivative work that is substantially the Software — available to third parties as a standalone product, platform, or service, under Your own brand, a white-labeled brand, or otherwise, where the primary value delivered to those third parties is the Software's own functionality (e.g., agent orchestration, workflow execution, knowledge base management). This includes, without limitation:
   - Offering hosted or on-premise "Snipet" access (rebranded or not) to Your customers as a product;
   - Rebranding the Software and distributing or reselling it, in whole or substantial part, as Your own product.

  For clarity, using the Software as an internal engine or infrastructure component behind a distinct product or service of Your own — where Your customers interact with Your product, not with Snipet directly — is permitted and considered an Internal Business Purpose.

b. **Redistribution.** You may distribute or make available copies or derivative works of the Software to third parties only if such distribution is free of charge and does not violate Section 3(a).

c. **Notices.** You may not remove, alter, or obscure any copyright, trademark, or licensing notices included in the Software.

d. **Trademarks.** This License does not grant You any right to use the Licensor's names, logos, or trademarks, except as necessary to reproduce the notices required by this License.
...
Your rights under this License will terminate automatically if You fail to comply with any of its terms. Upon termination, You must cease all use, copying, and distribution of the Software. Sections 6, 8, and 9 survive termination.
