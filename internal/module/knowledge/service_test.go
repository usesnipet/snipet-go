...
func (s *stubSourceDriver) Iterator(context.Context, util.JSONMap) (kdriver.IKnowledgeIterator, error) {
	return nil, nil
}

func (s *stubSourceDriver) Reader(context.Context, util.JSONMap, string) (kdriver.IKnowledgeReader, error) {
	return nil, nil
}
