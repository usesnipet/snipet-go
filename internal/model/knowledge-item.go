...
type KnowledgeItem struct {
	...
	Attributes   jsonx.JSONMap            `gorm:"type:jsonb" json:"attributes"`
	...
	Indexes   []IndexedKnowledgeItem `gorm:"foreignKey:KnowledgeItemID;constraint:OnDelete:CASCADE" json:"indexes"`
}
