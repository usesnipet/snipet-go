...
DROP TABLE "members";
-- reverse: create index "idx_indexed_knowledge_items_tenant_id" to table: "indexed_knowledge_items"
DROP INDEX "idx_indexed_knowledge_items_tenant_id";
...
-- reverse: create index "idx_knowledge_items_tenant_id" to table: "knowledge_items"
DROP INDEX "idx_knowledge_items_tenant_id";
...
-- reverse: create index "idx_execution_messages_tenant_id" to table: "execution_messages"
DROP INDEX "idx_execution_messages_tenant_id";
...
-- reverse: create index "idx_executions_tenant_id" to table: "executions"
DROP INDEX "idx_executions_tenant_id";
...
-- reverse: create index "idx_sessions_tenant_id" to table: "sessions"
...
-- reverse: create index "idx_clients_tenant_id" to table: "clients"
DROP INDEX "idx_clients_tenant_id";
-- reverse: create "clients" table
DROP TABLE "clients";
-- reverse: create "client_users" table
DROP TABLE "client_users";
-- reverse: create index "idx_api_keys_tenant_id" to table: "api_keys"
...
-- reverse: create index "idx_llms_tenant_id" to table: "llms"
DROP INDEX "idx_llms_tenant_id";
...
-- reverse: create index "idx_knowledge_indices_tenant_id" to table: "knowledge_indices"
DROP INDEX "idx_knowledge_indices_tenant_id";
...
-- reverse: create index "idx_knowledges_tenant_id" to table: "knowledges"
DROP INDEX "idx_knowledges_tenant_id";
-- reverse: create "knowledges" table
DROP TABLE "knowledges";
-- reverse: create index "idx_agents_tenant_id" to table: "agents"
DROP INDEX "idx_agents_tenant_id";
